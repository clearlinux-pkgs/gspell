...
Source0  : https://download.gnome.org/sources/gspell/1.13/gspell-1.13.1.tar.xz
...
%prep
%setup -q -n gspell-1.13.1
cd %{_builddir}/gspell-1.13.1
pushd ..
cp -a gspell-1.13.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722869817
