...
Source0  : https://download.gnome.org/sources/gspell/1.14/gspell-1.14.0.tar.xz
...
%prep
%setup -q -n gspell-1.14.0
cd %{_builddir}/gspell-1.14.0
pushd ..
cp -a gspell-1.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726782520
