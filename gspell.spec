...
Source0  : https://download.gnome.org/sources/gspell/1.8/gspell-1.8.4.tar.xz
...
%prep
%setup -q -n gspell-1.8.4
cd %{_builddir}/gspell-1.8.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600280202
...
cp %{_builddir}/gspell-1.8.4/COPYING %{buildroot}/usr/share/package-licenses/gspell/5013d109e2fe11116d2b062bb46114a398276501
%make_install
%find_lang gspell-1
...
/usr/lib64/libgspell-1.so.2.3.0
