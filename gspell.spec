...
Source0  : https://download.gnome.org/sources/gspell/1.9/gspell-1.9.1.tar.xz
...
%prep
%setup -q -n gspell-1.9.1
cd %{_builddir}/gspell-1.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612481350
...
cp %{_builddir}/gspell-1.9.1/COPYING %{buildroot}/usr/share/package-licenses/gspell/5013d109e2fe11116d2b062bb46114a398276501
%make_install
%find_lang gspell-1
